...
export class AirComponent implements OnInit {
  ...
  query() {
    ...
    if (id == '') id = "0";
    this.devices$ = <Observable<device>>this.hc.get(this.baseUrl + 'device/air-conditioner/' + Number.parseInt(id));
  ...
  delete(id) {
    // console.log("de")
    this.hc.delete(this.baseUrl + 'device/air-conditioner/' + id).subscribe((val: any) => {
      this.page$ = 1;
      // console.log("delete")
      this.init();
    })
